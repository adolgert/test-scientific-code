...
randomly and the population responds to those changes.
...
randomly with each time step. It rises in fits and starts.}
\end{figure}

\begin{figure}
\centering\includegraphics[width=4in]{insects_long.pdf}
\caption{Over longer times, the early rise in the population
is less important. The population varies around some average value.}
\end{figure}
...
parameters, produces a particular distribution of sizes.}
\end{figure}
