...
\end{tabular}
\end{center}
The table gives a good look at what tests we will run, and code
...
and how many are enough, and equivalence classes are an approach
to this question.
...
They're both incomplete representations of how state and execution
