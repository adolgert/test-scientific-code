...
% Qualities in code differ between scientific and non-scientific
% The lifetime of a single component begins with emphasis on
% changing the code easily, moves to emphasis on correctness,
% and ends with emphasis on usability (adding options).
