...
\section{Testing by classes of parameters}\label{sec:parameter-logic}

When our expectations reduce to a rule: if I send this in, then it
sends that back.
...
\subsection{Parameter equivalence}\label{sec:limits}
