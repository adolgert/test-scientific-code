...
\begin{itemize}
    \item Set scope: functional, the right answer.
    \item Not performance, security, usability.
\end{itemize}
...
\begin{itemize}
    ...
    and branching statements. A mistaken condition can mean that
...
While algorithm defects are immediate threats to correctness, we
tend to find them early in development and testing, and
tests in assignment and checking are no less harmful.
