...
There are a number of statistical questions we could ask about
this function.
\begin{itemize}
	\item Test that the mean and standard deviation are what I expect.
	      In the case that the distribution has known properties, I could
	      test the output against those known properties.

	\item Test whether this function gives values higher or lower
	      than a similar function I used previously.
\end{itemize}
There are statistical methods to address these questions.
...
\begin{itemize}
	...
	\item Regression test when writing a new version of that code,
	      either for refactoring or for a modifcation in function.
