...
% Joint attention.
% - Focus is a specific function.
% - Focus is a kind of function.
%   The function is presented to us with a question about correctness.
% - Focus is a pile of statistical tests.
%
% The network.
% - The code itself could be simulation.
% - The code itself could be deterministic.
% - The data could be randomly generated (by your test).
% - When and how you run unit tests.

% random gaussian elimination (nondeterministic). simulation.
