...
a jumble of parameters. We identified edge cases\index{edge cases} that come from
...
\nodindent{}The given function should give an exact fit if
...
\subsubsection{Testing the chip architecture}
...
Same distribution with different parameterization.
...
L1 norm. Least squares. Sum of absolute value.


\subsection{Regression tests}
Not regressive at all. This is a form of regression testing.
